...
import { z } from 'zod';
import { Car, Building, Truck } from 'lucide-react';
...
const RegisterForm = ({ onRegisterSuccess }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-emerald-50">
      ...
      >
        <h2 className="text-2xl font-bold text-center font-['Poppins']">Register</h2>

        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {/* Role selection */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2 font-['Lato']">Select Your Role</label>
          ...
          {/* Name */}
          <div>
            <label className="block text-sm font-medium text-gray-700 font-['Lato']">Name</label>
            <input {...register('name')} type="text" className="border p-2 rounded w-full" placeholder="Your name" />
          ...
          <div>
            ...
            <input {...register('email')} type="email" className="border p-2 rounded w-full" placeholder="Email address" />
          ...
          <div>
            ...
            <input {...register('password')} type="password" className="border p-2 rounded w-full" placeholder="Password" />
